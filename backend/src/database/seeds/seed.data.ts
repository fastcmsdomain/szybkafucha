...
export const seedContractors = [
  ...
  },
  {
    ...
    profile: {
      ...
      categories: [
        TaskCategory.MONTAZ,
        TaskCategory.PRZEPROWADZKI,
        TaskCategory.NAPRAWY,
        TaskCategory.ZLOTA_RACZKA,
        TaskCategory.HYDRAULIK,
        TaskCategory.ELEKTRYK,
      ],
      serviceRadiusKm: 20,
      kycStatus: KycStatus.VERIFIED,
      kycIdVerified: true,
  ...
  },
  {
    ...
    profile: {
      ...
      categories: [
        TaskCategory.SPRZATANIE,
        TaskCategory.OGROD,
        TaskCategory.MALOWANIE,
      ],
      serviceRadiusKm: 10,
      kycStatus: KycStatus.VERIFIED,
      kycIdVerified: true,
...
export const seedTasks = [
  ...
  // New category coverage tasks (11 categories)
  {
  ...
  },
  {
    ...
    title: 'Wyprowadzenie psa wieczorem',
    description: 'Spokojny labrador, spacer około 45 minut dziś wieczorem.',
    locationLat: 52.245,
    locationLng: 21.03,
    address: 'ul. Radzymińska 18, 03-752 Warszawa',
    budgetAmount: 55,
    status: TaskStatus.CREATED,
    scheduledAt: new Date(Date.now() + 21600000), // in 6 hours
  },
  {
  ...
  },
  {
    ...
    title: 'Powieszenie dwóch półek i lustra',
    description: 'Montaż dwóch półek i lustra w przedpokoju, ściana z cegły.',
    locationLat: 52.238,
    locationLng: 21.055,
    address: 'ul. Kijowska 11, 03-738 Warszawa',
    budgetAmount: 95,
    status: TaskStatus.CREATED,
    scheduledAt: null,
  },
  {
    id: '33333333-3333-3333-3333-333333333347',
    clientId: seedClients[2].id,
    contractorId: null,
  ...
  {
    id: '33333333-3333-3333-3333-333333333348',
    clientId: seedClients[0].id,
    contractorId: null,
  ...
  {
    id: '33333333-3333-3333-3333-333333333349',
    clientId: seedClients[1].id,
    contractorId: null,
    ...
    budgetAmount: 140,
    status: TaskStatus.CREATED,
    scheduledAt: new Date(Date.now() + 604800000), // in 7 days
  },
];
