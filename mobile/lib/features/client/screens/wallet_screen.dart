    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              '10 zl = pomocnik. Platisz tylko gdy wybierzesz wykonawce.',
              style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Starczy na ${(credits.balance / 10).floor()} dopasowan',
            style: const TextStyle(
              color: Colors.white70,
              fontSize: 13,
            ),
...
/// Bottom sheet for selecting top-up amount
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color:
                                isSelected ? AppColors.white : AppColors.gray900,
                          ),
                        ),
                      ),
                    ),
