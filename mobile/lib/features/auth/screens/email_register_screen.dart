...
class _EmailRegisterScreenState extends ConsumerState<EmailRegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      context.push(Routes.emailVerify, extra: _emailController.text.trim());
    } catch (e) {
      if (!mounted) return;
      setState(() {
          ...
          if (_errorMessage!.contains('już istnieje'))
            TextButton(
              ...
              style: TextButton.styleFrom(
                padding: EdgeInsets.symmetric(horizontal: AppSpacing.gapSM),
              ),
              child: Text(
                'Zaloguj się',
  ...
  Widget _buildPasswordStrength() {
    ...
    return Column(
      ...
      children: [
        ...
        _buildRequirement('Znak specjalny (@\$!%*?&#)', _hasSpecial),
      ],
    );
  }
