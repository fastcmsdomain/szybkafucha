...
- [ ] Zaktualizować URL-e w meta tagach
- [ ] Skonfigurować endpoint API dla newslettera
- [ ] Dodać Google Analytics / Facebook Pixel
- [ ] Stworzyć strony: Polityka Prywatności, Regulamin, Cookies
- [ ] Zminifikować CSS i JS (opcjonalnie)
- [ ] Skonfigurować HTTPS i domenę
